...
const AlertTemplate = ({ style, options, message, close, className }) => (
    <AlertContainer className={className} style={style}>
        {options.type === "info" && (
            <BSAlert variant="info" close={close} dismissible message={message} />
        )}
        {options.type === "success" && (
            <BSAlert variant="success" close={close} dismissible message={message} />
        )}
        {options.type === "error" && (
            <BSAlert variant="danger" close={close} dismissible message={message} />
        )}
    </AlertContainer>
);
